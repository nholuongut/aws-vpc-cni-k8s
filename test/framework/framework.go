...
import (
	...
	sgpscheme "github.com/nholuongut/amazon-vpc-resource-controller-k8s/apis/vpcresources/v1beta1"
	...
	"github.com/nholuongut/amazon-vpc-cni-k8s/test/framework/controller"
	"github.com/nholuongut/amazon-vpc-cni-k8s/test/framework/helm"
	"github.com/nholuongut/amazon-vpc-cni-k8s/test/framework/resources/nholuongut"
	"github.com/nholuongut/amazon-vpc-cni-k8s/test/framework/resources/k8s"
...
type Framework struct {
	...
	CloudServices       nholuongut.Cloud
...
func New(options Options) *Framework {
	...
	cloudConfig := nholuongut.CloudConfig{Region: options.nholuongutRegion, VpcID: options.nholuongutVPCID,
		EKSEndpoint: options.EKSEndpoint}

	return &Framework{
		Options:             options,
		K8sClient:           k8sClient,
		CloudServices:       nholuongut.NewCloud(cloudConfig),
