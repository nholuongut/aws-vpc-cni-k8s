...
var _ = BeforeSuite(func() {
	...
	if isIPv4Cluster {
		...
		k8sUtils.AddEnvVarToDaemonSetAndWaitTillUpdated(f, "nholuongut-node", "kube-system",
			"nholuongut-vpc-cni-init", map[string]string{
				"ENABLE_V6_EGRESS": "true",
			})
	}
})
...
var _ = AfterSuite(func() {
	...
	k8sUtils.RemoveVarFromDaemonSetAndWaitTillUpdated(f, "nholuongut-node", "kube-system",
		"nholuongut-vpc-cni-init", map[string]struct{}{
			"ENABLE_V6_EGRESS": {},
		})
	k8sUtils.RemoveVarFromDaemonSetAndWaitTillUpdated(f, "nholuongut-node", "kube-system",
		"nholuongut-node", map[string]struct{}{
			"ENABLE_V6_EGRESS": {},
		})
})
