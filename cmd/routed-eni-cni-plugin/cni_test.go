...
import (
	...
	mock_driver "github.com/nholuongut/amazon-vpc-cni-k8s/cmd/routed-eni-cni-plugin/driver/mocks"
	mock_grpcwrapper "github.com/nholuongut/amazon-vpc-cni-k8s/pkg/grpcwrapper/mocks"
	mock_rpcwrapper "github.com/nholuongut/amazon-vpc-cni-k8s/pkg/rpcwrapper/mocks"
	mock_typeswrapper "github.com/nholuongut/amazon-vpc-cni-k8s/pkg/typeswrapper/mocks"
	"github.com/nholuongut/amazon-vpc-cni-k8s/rpc"
	mock_rpc "github.com/nholuongut/amazon-vpc-cni-k8s/rpc/mocks"
)
...
const (
	...
	ifName         = "eth0"
	cniVersion     = "1.1"
	cniName        = "nholuongut-cni"
	pluginLogLevel = "Debug"
	pluginLogFile  = "/var/log/nholuongut-routed-eni/plugin.log"
	cniType        = "nholuongut-cni"
	ipAddr         = "10.0.1.15"
	devNum         = 4
)
