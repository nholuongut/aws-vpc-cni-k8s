...
// Source: github.com/nholuongut/amazon-vpc-cni-k8s/pkg/networkutils (interfaces: NetworkAPIs)
...
// CleanUpStalenholuongutChains mocks base method.
func (m *MockNetworkAPIs) CleanUpStalenholuongutChains(arg0, arg1 bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanUpStalenholuongutChains", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanUpStalenholuongutChains indicates an expected call of CleanUpStalenholuongutChains.
func (mr *MockNetworkAPIsMockRecorder) CleanUpStalenholuongutChains(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanUpStalenholuongutChains", reflect.TypeOf((*MockNetworkAPIs)(nil).CleanUpStalenholuongutChains), arg0, arg1)
}
