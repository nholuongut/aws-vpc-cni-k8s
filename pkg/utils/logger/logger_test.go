...
func TestGetLogFileLocationReturnsDefaultPath(t *testing.T) {
	defaultPath := "/host/var/log/nholuongut-routed-eni/ipamd.log"
...
func TestGetPluginLogFilePath(t *testing.T) {
	inputPluginLogFile := "/var/log/nholuongut-routed-eni/plugin.log"
	expectedLumberJackLogger := &lumberjack.Logger{
		Filename:   "/var/log/nholuongut-routed-eni/plugin.log",
		MaxSize:    100,
		MaxBackups: 5,
		MaxAge:     30,
		Compress:   true,
