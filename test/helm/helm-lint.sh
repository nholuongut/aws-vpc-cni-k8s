...
AM_HELM_CHART=$SCRIPTPATH/../../charts/nholuongut-vpc-cni/
...
helm template nholuongut-vpc-cni "${HELM_DIR}/nholuongut-vpc-cni" --debug --namespace=kube-system -f "${HELM_DIR}/nholuongut-vpc-cni/values.yaml" > /dev/null

echo "=============================================================================="
echo "                   Generate Template w/ Helm v2"
echo "=============================================================================="

helm2 template --name nholuongut-vpc-cni "${HELM_DIR}/nholuongut-vpc-cni" --debug --namespace=kube-system -f "${HELM_DIR}/nholuongut-vpc-cni/values.yaml" > /dev/null
