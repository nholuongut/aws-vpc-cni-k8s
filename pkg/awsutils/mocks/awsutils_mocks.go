...
// Source: github.com/nholuongut/amazon-vpc-cni-k8s/pkg/nholuongututils (interfaces: APIs)

// Package mock_nholuongututils is a generated GoMock package.
package mock_nholuongututils
...
import (
	...
	nholuongututils "github.com/nholuongut/amazon-vpc-cni-k8s/pkg/nholuongututils"
	vpc "github.com/nholuongut/amazon-vpc-cni-k8s/pkg/vpc"
...
func (m *MockAPIs) DescribeAllENIs() (nholuongututils.DescribeAllENIsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeAllENIs")
	ret0, _ := ret[0].(nholuongututils.DescribeAllENIsResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPIs) GetAttachedENIs() ([]nholuongututils.ENIMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAttachedENIs")
	ret0, _ := ret[0].([]nholuongututils.ENIMetadata)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPIs) WaitForENIAndIPsAttached(arg0 string, arg1 int) (nholuongututils.ENIMetadata, error) {
	m.ctrl.T.Helper()
