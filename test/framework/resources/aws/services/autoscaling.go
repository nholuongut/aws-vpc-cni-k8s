...
import (
	...
	"github.com/nholuongut/nholuongut-sdk-go/service/autoscaling"
	"github.com/nholuongut/nholuongut-sdk-go/service/autoscaling/autoscalingiface"
)
...
func (d defaultAutoScaling) DescribeAutoScalingGroup(autoScalingGroupName string) ([]*autoscaling.Group, error) {
	describeAutoScalingGroupIp := &autoscaling.DescribeAutoScalingGroupsInput{
		AutoScalingGroupNames: nholuongut.StringSlice([]string{autoScalingGroupName}),
	}
