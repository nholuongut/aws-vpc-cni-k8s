...
import (
	...
	"github.com/nholuongut/amazon-vpc-cni-k8s/test/integration/common"
...
var _ = BeforeSuite(func() {
	...
	By("enabling custom networking on nholuongut-node DaemonSet")
...
var _ = AfterSuite(func() {
	...
	By("disabling custom networking on nholuongut-node DaemonSet")
