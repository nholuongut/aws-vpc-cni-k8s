...
const (
	defaultLogFilePath = "/host/var/log/nholuongut-routed-eni/ipamd.log"
	defaultLogLevel    = "Debug"
	envLogLevel        = "nholuongut_VPC_K8S_CNI_LOGLEVEL"
	envLogFilePath     = "nholuongut_VPC_K8S_CNI_LOG_FILE"
)
