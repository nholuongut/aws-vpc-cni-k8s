...
jq -c '.[]' $REGIONS_FILE | while read i; do
    ...
    $BUILD_DIR/helm template nholuongut-vpc-cni \
      --include-crds \
      ...
      --namespace $NAMESPACE \
      $SCRIPTPATH/../charts/nholuongut-vpc-cni > $NEW_CNI_RESOURCES_YAML
...
echo "Generated nholuongut-vpc-cni and cni-metrics-helper manifest resources files in:"
