...
func init() {
	flag.StringVar(&imageRepository, "cni-metrics-helper-image-repo", "602401143452.dkr.ecr.us-west-2.amazonnholuongut.com/cni-metrics-helper", "CNI Metrics Helper Image Repository")
...
var _ = BeforeSuite(func() {
	...
	// SO issue: https://stackoverflow.com/questions/66287626/nholuongut-cli-list-policies-to-find-a-policy-with-a-specific-name
	...
	By("updating the nholuongut-nodes to restart the metric count")
	k8sUtil.AddEnvVarToDaemonSetAndWaitTillUpdated(f, utils.nholuongutNodeName, utils.nholuongutNodeNamespace,
		utils.nholuongutNodeName, map[string]string{"SOME_NON_EXISTENT_VAR": "0"})
...
var _ = AfterSuite(func() {
	...
	k8sUtil.RemoveVarFromDaemonSetAndWaitTillUpdated(f, utils.nholuongutNodeName, utils.nholuongutNodeNamespace,
		utils.nholuongutNodeName, map[string]struct{}{"SOME_NON_EXISTENT_VAR": {}})
