...
import (
	...
	"github.com/nholuongut/amazon-vpc-cni-k8s/test/framework/resources/nholuongut/utils"
	testUtils "github.com/nholuongut/amazon-vpc-cni-k8s/test/framework/utils"
...
var _ = BeforeSuite(func() {
	...
	nholuongutUrl, err := url.Parse(providerID)
	Expect(err).NotTo(HaveOccurred())

	instanceID := path.Base(nholuongutUrl.Path)
