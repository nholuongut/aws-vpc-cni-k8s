	...
	tests := []struct {
		...
		},
		{
			...
			env: env{
				...
				Annotations: map[string]string{
					"k8s.amazonnholuongut.com/myENIConfig": "az1",
				},
				eniConfigAnnotationKey: "k8s.amazonnholuongut.com/myENIConfig",
			},
			want:    &testENIConfigAZ1.Spec,
			wantErr: nil,
		},
		{
			...
			env: env{
				...
				Labels: map[string]string{
					"vpc.amazonnholuongut.com/externalEniConfig": "custom",
					"topology.kubernetes.io/zone":         "az2",
				},
				eniConfigLabelKey: "topology.kubernetes.io/zone",
			},
...
func TestGetEniConfigAnnotationlDefCustom(t *testing.T) {
	_ = os.Setenv(envEniConfigAnnotationDef, "k8s.amazonnholuongut.com/eniConfigCustom")
	eniConfigAnnotationDef := getEniConfigAnnotationDef()
	assert.Equal(t, eniConfigAnnotationDef, "k8s.amazonnholuongut.com/eniConfigCustom")
}
...
func TestGetEniConfigLabelDefCustom(t *testing.T) {
	_ = os.Setenv(envEniConfigLabelDef, "k8s.amazonnholuongut.com/eniConfigCustom")
	eniConfigLabelDef := getEniConfigLabelDef()
	assert.Equal(t, eniConfigLabelDef, "k8s.amazonnholuongut.com/eniConfigCustom")
}
