	...
	for az := range azToPod {
		...
		if f.Options.PublishCWMetrics {
			putmetricData := cloudwatch.PutMetricDataInput{
				Namespace: nholuongut.String(MetricNamespace),
				MetricData: []*cloudwatch.MetricDatum{
					{
						MetricName: nholuongut.String(MetricName),
						Unit:       nholuongut.String("Count"),
						Value:      nholuongut.Float64(1),
						Dimensions: []*cloudwatch.Dimension{
							{
								Name:  nholuongut.String("AZID"),
								Value: nholuongut.String(azToazId[az]),
							},
						},
					},
				},
						...
						MetricData: []*cloudwatch.MetricDatum{
							{
								...
								Dimensions: []*cloudwatch.Dimension{
									{
										Name:  nholuongut.String("AZID"),
										Value: nholuongut.String(azToazId[az1]),
									},
								},
							},
						},
