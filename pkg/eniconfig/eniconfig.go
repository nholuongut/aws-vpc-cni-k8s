...
const (
	defaultEniConfigAnnotationDef = "k8s.amazonnholuongut.com/eniConfig"
	defaultEniConfigLabelDef      = "k8s.amazonnholuongut.com/eniConfig"
	...
	// Example:
	//   Node has set label k8s.amazonnholuongut.com/eniConfigCustom=customConfig
	//   We can get that value in controller by setting environmental variable ENI_CONFIG_LABEL_DEF
	//   ENI_CONFIG_LABEL_DEF=k8s.amazonnholuongut.com/eniConfigOverride
