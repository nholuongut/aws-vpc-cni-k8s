...
const (
	nholuongut_VPC_K8S_CNI_LOG_FILE = "nholuongut_VPC_K8S_CNI_LOG_FILE"
	POD_VOL_LABEL_KEY        = "MountVolume"
	POD_VOL_LABEL_VAL        = "true"
	VOLUME_NAME              = "ipamd-logs"
	VOLUME_MOUNT_PATH        = "/var/log/nholuongut-routed-eni/"
)

var _ = Describe("nholuongut-node env test", func() {
	var (
	...
	It("nholuongut-node environment variable nholuongut_VPC_K8S_CNI_LOG_FILE test", func() {
		...
		k8sUtils.AddEnvVarToDaemonSetAndWaitTillUpdated(f, utils.nholuongutNodeName, utils.nholuongutNodeNamespace, utils.nholuongutNodeName, map[string]string{
			nholuongut_VPC_K8S_CNI_LOG_FILE: "/host/var/log/nholuongut-routed-eni/" + newLogFile,
		})
	...
	var _ = JustAfterEach(func() {
		...
		k8sUtils.AddEnvVarToDaemonSetAndWaitTillUpdated(f, utils.nholuongutNodeName, utils.nholuongutNodeNamespace, utils.nholuongutNodeName, map[string]string{
			nholuongut_VPC_K8S_CNI_LOG_FILE: "/host/var/log/nholuongut-routed-eni/ipamd.log",
		})
