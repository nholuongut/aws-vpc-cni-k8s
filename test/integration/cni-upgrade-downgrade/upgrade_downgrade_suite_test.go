...
const (
	...
	DefaultManifestfile      = "https://raw.githubusercontent.com/nholuongut/amazon-vpc-cni-k8s/master/config/master/nholuongut-k8s-cni.yaml"
)
...
var _ = BeforeSuite(func() {
	...
	describeVPCOutput, err := f.CloudServices.EC2().DescribeVPC(f.Options.nholuongutVPCID)
	Expect(err).ToNot(HaveOccurred())
